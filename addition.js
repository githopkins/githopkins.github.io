...
$("input[type='radio'][name='lot-status']").on('input',function(e){
	var selectedLotStatus = $("input[type='radio'][name='lot-status']:checked").val();
	$("#property-type-selection").attr('value', selectedLotStatus);
});
$("input[type='radio'][name='credit-rating']").on('input',function(e){
	var selectedCreditRating = $("input[type='radio'][name='credit-rating']:checked").val();
	$("#credit-score-selection").attr('value', selectedCreditRating);
});
$("input[type='radio'][name='property-type']").on('input',function(e){
	var selectedOccupancyType = $("input[type='radio'][name='property-type']:checked").val();
	$("#occupancy-type-selection").attr('value', selectedOccupancyType);
});
