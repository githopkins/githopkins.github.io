$(function() {
	...
	if ($('body').hasClass('site-type-loan_officer')) {	
		...
		var dropbanner = '<div id="inserted-banner"><div class="container-section"><h3>' + loanoriginatorname + '<span>' + loanoriginatornmls + '</span></h3><div id="button-container-home" class="container-section"><a href="/testimonial">What People Say About Me</a><div id="mobile-apply"><a href="/loan/apply" id="loan-officer-header-apply">Apply Now</a></div><div id="mobile-telephone"><a href="tel:"' + loanoriginatornumber '" id="loan-officer-header-apply">Call Now</a></div></div></div></div>';
