		...
		if (document.cookie.indexOf("noshowlastoriginator=") < 0) {
			...
			if (window.location.href.indexOf(loanofficerlastvisited) < 0) {
				...
				if (document.cookie.indexOf("visitedloanoriginatorimage=") > 0) {
					$(document.body).append("<div id='lastvisitedoriginatornotice'><img src='" + loanofficerlastvisitedimage + "'><p>Hi! You visited " + loanofficerlastvisitednamedisplay + " before. Do you want to revisit their page? <a id='gotherenowtid' style='font-weight: 600' href='" + loanofficerlastvisited  + "'>Go Back Now</a><a id='dismisslastvisitor'>Dismiss this message</a></p></div>");
				};
				if (document.cookie.indexOf("visitedloanoriginatorimage=") < 0) {
					$(document.body).append("<div id='lastvisitedoriginatornotice'><p>Hi! You visited " + loanofficerlastvisitednamedisplay + " before. Do you want to revisit their page? <a id='gotherenowtid' style='font-weight: 600' href='" + loanofficerlastvisited  + "'>Go Back Now</a><a id='dismisslastvisitor'>Dismiss this message</a></p></div>");
				};
