$(document).ready(function() {
	...
	$("#sudoux_mortgagebundle_loanapplicationtype_borrower_birth_date").prop("value", "");
	...
	$("#sudoux_mortgagebundle_loanapplicationtype_borrower_employment_0_start_date").prop("value", "");
	...
	$("#sudoux_mortgagebundle_loanapplicationtype_borrower_employment_0_end_date").prop("value", "");
