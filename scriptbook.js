...
$(document).ready(function() {
	...
	$('#sudoux_mortgagebundle_loanapplicationtype_borrower_employment_0_end_date').addClass('newdatepicker');
	...
	$('#sudoux_mortgagebundle_loanapplicationtype_borrower_employment_1_end_date').addClass('newdatepicker');
	...
	$('#sudoux_mortgagebundle_loanapplicationtype_borrower_employment_2_end_date').addClass('newdatepicker');
